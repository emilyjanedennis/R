...
##what did I do today?
made a to do list:
1. find N2 plate experiments from pre-spreadsheet era (on/off 0.15% DEET) OR change this Fig 1 observation to dose response curve (maybe logic flow should be: 1. DEET is NOT spot-effective 2. drc IN AGAROSE 3. screen...)
2. add stats for spots data and drc if added
